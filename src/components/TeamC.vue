<template>
    <div class="pt-40">
        <h1 class="text-4xl my-4 font-extrabold text-center"><span class="underline underline-offset-8 decoration-green-600 decoration-4">Our </span>Team</h1>

        <div class="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 text-center md:mx-40 my-20">
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Purity.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Purity Mutiga</span>
                <span class="text-xl pt-2">Head of Administration</span>
            </div>
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Marsha.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Marsha Sitati</span>
                <span class="text-xl pt-2">Head Liaison Officer</span>
            </div>
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Elizabeth.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Elizabeth Mwania</span>
                <span class="text-xl pt-2">Administrative Officer</span>
            </div>
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Susan.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Susan Muriuki</span>
                <span class="text-xl pt-2">Finance Officer</span>
            </div>
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Prince.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Princeton Nyanja</span>
                <span class="text-xl pt-2">Liaison Officer</span>
            </div>
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Lucy.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Lucy Mueni</span>
                <span class="text-xl pt-2">Liaison Officer</span>
            </div>
            <!----<div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Warda.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Warda Musa</span>
                <span class="text-xl pt-2">Assistant Liaison Officer</span>
            </div>-->
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Ashley.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Ashley Otieno</span>
                <span class="text-xl pt-2">Liaison Officer</span>
            </div>
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Warren.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Warren Bahati</span>
                <span class="text-xl pt-2">Liaison Officer</span>
            </div>
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Wendy.png" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Wendy Achieng</span>
                <span class="text-xl pt-2">Liaison Officer</span>
            </div>
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Wanjiru.jpg" alt="" class="rounded-full w-64 h-64">

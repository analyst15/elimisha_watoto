<template>
    <div class="pt-40">
        <h1 class="text-4xl my-4 font-extrabold text-center"><span
                class="underline underline-offset-8 decoration-green-600 decoration-4">Our </span>Team</h1>
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 text-center md:mx-40 my-20">
            ...
            <div class="flex flex-col mt-8 items-center">
                <img src="../assets/staff/Susan W.jpg" alt="" class="rounded-full w-64 h-64">
                <span class="font-bold text-xl pt-2 ">Susan Wambui</span>
                <span class="text-xl pt-2">Administration Officer - Tertiary</span>
            </div>
